(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-b2496998"], {
    "022a": function (t, e, s) {
        "use strict";
        ...
        var i = function () {
            ...
            return t.disabledFlag ? s("v-card", {
                staticClass: "pt-5",
                attrs: {flat: "", tile: ""}
            }, [s("v-card-title", {staticClass: "mb-3"}, [s("v-layout", {attrs: {"justify-center": ""}}, ["readonly" === t.status ? s("div", {staticStyle: {"text-align": "justify"}}, [s("span", {
                staticStyle: {
                    "font-weight": "bold",
                    "font-size": "24px",
                    width: "100%",
            ...
            }, [t._v("\n          " + t._s(t.passStatus) + "\n        ")])]) : t.self.resultMsg.length > 0 ? s("v-layout", {
                attrs: {
                    column: "",
                    "justify-center": ""
                }
            }, t._l(t.self.resultMsg, function (e) {
                return s("v-flex", {attrs: {xs12: ""}}, ["1" === t.self.result ? s("div", {staticStyle: {"text-align": "justify"}}, [s("span", {
                    staticStyle: {
                        "font-weight": "bold",
                        color: "green",
                        "font-size": "24px",
                ...
                }, [t._v(t._s(e))])]) : "2" === t.self.result ? s("div", {staticStyle: {"text-align": "justify"}}, [s("span", {
                    staticStyle: {
                        "font-weight": "bold",
                        color: "blue",
                        "font-size": "24px",
                ...
                }, [t._v(t._s(e))])]) : "0" === t.self.result ? s("div", {staticStyle: {"text-align": "justify"}}, [s("span", {
                    staticStyle: {
                        "font-weight": "bold",
                        color: "red",
                        "font-size": "24px",
            ...
            }), 1) : s("div", {staticStyle: {"text-align": "justify"}}, [s("span", {
                staticStyle: {
                    "font-weight": "bold",
                    color: "red",
                    "font-size": "24px",
            ...
            }, [t._v("请重新扫码登记")])])], 1)], 1), s("v-list", [t._l(t.opts, function (e, i) {
                return [e.divider ? s("v-divider", {key: i + "divider"}) : t._e(), e.icon || e.title || e.subTitle ? s("v-list-tile", {key: i}, [s("v-list-tile-action", [s("v-layout", [s("v-icon", {domProps: {textContent: t._s(e.icon)}}), s("span", {staticClass: "ml-2 mr-2"}, [t._v(t._s(e.subTitle))])], 1)], 1), s("v-list-tile-content", ["" === e.type ? s("v-list-tile-title", {class: -1 !== e.title.indexOf("学生") || -1 !== e.title.indexOf("研究生") || -1 !== e.title.indexOf("继教生") ? "warning--text" : ""}, [s("v-layout", {attrs: {"justify-end": ""}}, [s("h2", [t._v(t._s(e.title.trim() || "N/A"))])])], 1) : s("v-list-tile-title", {class: [e.title ? "primary--text" : "grey--text"]}, [s("v-layout", {attrs: {"justify-end": ""}}, [s("h3", {staticStyle: {width: "180px"}}, [s("Marquee", {attrs: {lists: e.arr}})], 1)])], 1)], 1)], 1) : t._e(), e.subheader ? s("v-subheader", {key: i + "subheader"}, [t._v(t._s(e.subheader))]) : t._e()]
            })], 2), "readonly" === t.status ? s("v-layout", {attrs: {"justify-center": ""}}, [s("v-btn", {
                attrs: {color: "primary"},
                on: {click: t.returnRecord}
            }, [t._v("返回")])], 1) : t._e(), s("v-dialog", {
                attrs: {width: "600"},
                model: {
            ...
            }, [s("v-layout", {attrs: {column: ""}}, [s("v-card", {staticClass: "pa-3"}, [s("v-layout", {attrs: {column: ""}}, [s("v-textarea", {
                staticStyle: {"line-height": "10em"},
                attrs: {"auto-grow": "", readonly: ""},
                model: {
                    value: t.confirmDialog.msg, callback: function (e) {
                        t.$set(t.confirmDialog, "msg", e)
                    }, expression: "confirmDialog.msg"
                }
            }), s("v-layout", {attrs: {"justify-center": ""}}, [s("v-btn", {
                staticClass: "primary",
            ...
            }, [t._v("取消")])], 1)], 1)], 1)], 1)], 1)], 1) : s("v-layout", {
                staticClass: "mt-4",
            ...
            }), s("span", {staticClass: "mt-2"}, [t._v("正在进行扫码登记")])], 1)
        ...
        }, f = c, d = (s("022a"), s("2877")), h = Object(d["a"])(f, o, u, !1, null, "43a209c8", null), p = h.exports;
        ...
        var m = {
                name: "tempSelfSign", computed: {
                    ...
                    return {
                        ...
                        confirmDialog: {
                            activated: !1,
                            msg: "【电子科技大学】全体师生员工：\n\t根据学校应对新型冠状病毒感染肺炎疫情防控工作领导小组工作部署，为了广大师生健康安全，自2020年1月28日下午6时起，实施校门临时管控措施。\n1、暂停校园交通管理系统的车行和人行预约功能；\n2、所有未经注册认证车辆一律不准许进入校园；\n3、校园不接待参观者和无关人员，本校师生员工除因保障、值守或应急等工作事由之外原则上不得进校，不得携带家属及校外亲友进校；\n4、清水河校区仅开放西门人行和车行通道，沙河校区仅开放东门人行和车行通道，其他门的人行和车行通道全部关闭；\n5、所有入校车辆和人员必须凭有效身份证件 本校师生证明证件（如工作证、工牌或一卡通等）进校；\n6、请广大教职工理解并配合校门岗位人员做好体温检测、盘问和信息登记工作。\n特殊时期，特殊管理，由此带来的不便，敬请大家理解、支持和配合。"
                        },
                        self: {
                            name: "",
                            loginId: "",
                    ...
                    this.confirmDialog.activated = !0, void 0 !== this.$route.query.status && "readonly" === this.$route.query.status && (this.status = "readonly", this.self.passTime = l["a"].stringify(this.$route.query.passTime), this.disabledFlag = !0, this.confirmDialog.activated = !1, this.passStatus = this.$route.query.passStatus, this.passStatus.indexOf("授权有效嘛") ? this.self.result = "1" : this.self.result = "0"), this.getSelfInfo(), this.sign()
                }, methods: {
                        ...
                        var t = v(r.a.mark(function t() {
                            ...
                            return r.a.wrap(function (t) {
                                while (1) switch (t.prev = t.next) {
                                    ...
                                    case 2:
                                        e = t.sent, 1 === e.data.status ? this.dealSelfInfo(e.data.data) : this.$L.alert("error", {message: "未查询到该用户信息"});
                                    case 4:
                                    case"end":
                                        return t.stop()
                                }
            ...
            }, y = m, b = s("6544"), x = s.n(b), w = s("8336"), T = s("b0af"), S = s("12b2"), _ = s("169a"), k = s("ce7e"),
            I = s("0e8f"), $ = s("132d"), C = s("a722"), D = s("8860"), V = s("ba95"), L = s("40fe"), j = s("5d23"),
            q = s("490a"), M = s("e0c7"), O = s("a844"), F = Object(d["a"])(y, i, a, !1, null, "477b291f", null);
        e["default"] = F.exports;
        x()(F, {
            VBtn: w["a"],
            VCard: T["a"],
...
//# sourceMappingURL=chunk-b2496998.22d547d3.js.map